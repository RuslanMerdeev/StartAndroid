package com.merdeev.sqliteonupgradedb;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void writeStaff(SQLiteDatabase db) {
        ...
        c = db.rawQuery("select people.name as Name, position.name as Position, position.salary as Salary from people inner join position on people.posid=position._id", null);
        logCursor(c, "Table people");
        c.close();
    }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (oldVersion == 1 && newVersion == 2) {
                ...
                try {
                    ...
                    db.execSQL("insert into people select _id, name, posid from people_tmp;");
