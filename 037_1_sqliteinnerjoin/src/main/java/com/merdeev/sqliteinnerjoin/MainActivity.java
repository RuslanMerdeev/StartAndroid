package com.merdeev.sqliteinnerjoin;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String table = "people inner join position on people.posid = position.id";
        String columns[] = { "people.name as Name", "position.name as Position", "position.salary as Salary" };
        String selection = "position.salary < ?";
